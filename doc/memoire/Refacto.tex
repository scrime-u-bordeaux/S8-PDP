...
\paragraph{}
Comme cette méthode affichage contient uniquement un serveur et un affichage
de matrice via une image, le programme se retrouve
extrêment allégé par rapport au programme de notre prédécesseur qui utilisais
Firefox ainsi que NodeJS.
