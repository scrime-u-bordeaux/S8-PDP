...
mais la raison principale est que BELA est basé sur un système (Xenomai Linux) %link : https://bela.io/
qui lui permet de faire du traitement audio en temps réel avec un temps de
latence extrêmement faible (100us).
%explication xenomai
...
programme.
% PLUS DE CHOSES A DIRE SUR LE BELA, HISTOIRE DE LATENCES
\paragraph{}
