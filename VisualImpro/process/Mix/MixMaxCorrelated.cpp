 ...
 *  \date    March 2018
 *
 *  \brief Code containing the mix based on maximal correlations function.
 *
 ...
 *  correlation it has with others instruments. Here the most correlated
 *  instruments are played louder.
 *
 */

#include "MixMaxCorrelated.hpp"
